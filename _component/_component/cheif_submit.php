...
if($pfid==0){
    ...
    //接收表单传递的用户名和密码
    $pfcheif=$_POST['pfcheif'];
	$pfcheifcomment=$_POST['pfcheifcomment'];
	$pfcheifdate=date('Y-m-d H:i:s');

	//通过php进行insert操作
	$sqlinsert="update programming SET pfcheif='{$pfcheif}',pfcheifdate='{$pfcheifdate}', pfcheifcomment='{$pfcheifcomment}' where pfid='{$pfid}'";
